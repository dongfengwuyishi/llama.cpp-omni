...
class WorkerPool:
    ...
    def __init__(
        ...
        # Duplex 结束后 Worker 可能处于 LOADING（C++ full_reinit），就绪后再参与调度
    ...
    async def start(self) -> None:
        """启动连接池"""
        # trust_env=False: workers 都是 loopback (127.0.0.1:xxxx)，
    ...
    def release_worker(self, worker: WorkerConnection, request_type: Optional[str] = None,
        ...
        Args:
            ...
            post_release_status: 释放后状态。默认 IDLE；C++ Duplex full_reinit 期间为 LOADING。
        """
